      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="{{asset('storage/media/banner/'.$list ->image)}}" alt="" />
              </div>
              @if ($list ->btn_text != '')
                  <div class="seq-title">
                 ...
                 <ul class="aa-product-catg aa-trending-slider">
                    ...
                    <li>
                        ...
                        <a class="aa-add-card-btn"href="{{url('product/'.$productArr ->slug)}}"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                            <h4 class="aa-product-title"><a href="{{url('product/'.$productArr ->slug)}}">{{$productArr ->name}}</a></h4>
                            <span class="aa-product-price">Rs {{$home_trending_product_attr[$productArr ->id][0]->price}}</span><span class="aa-product-price"><del>Rs {{$home_trending_product_attr[$productArr ->id][0]->mrp}}</del></span>
                        </figcaption>
                        </figure>
                    </li>
                    @endforeach
