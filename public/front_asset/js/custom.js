...
function home_add_to_cart(id, size_str_id, color_str_id) {
    var color_id = jQuery('#color_id').val(color_str_id);
    var size_id = jQuery('#size_id').val(size_str_id);
...
function add_to_cart(id, size_str_id, color_str_id) {
    ...
    if (size_id == '' && size_id != 'no') {
        jQuery('#add_to_cart_msg').html('<div class="alert mt10 alert-danger alert-dismissible fade in"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>Please select size</div>');
    } else if(color_id == '' && color_id != 'no') {
        jQuery('#add_to_cart_msg').html('<div class="alert mt10 alert-danger alert-dismissible fade in"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>Please select color</div>');
    } else {
